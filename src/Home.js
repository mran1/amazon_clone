...
function Home() {
    return (
        <div className="home">
            <img className="home__image" src="https://images-eu.ssl-images-amazon.com/images/G/31/prime/Gateway/2020/May/gaming_3000x1200._CB431281466_.jpg"
                alt="" />
            <div className="home__row">
                <Product
                    id="123"
                    title="The Lean Startup: How Constant Innovation Creates Radically Successful Businesses, helps you to get good ideas"
                    price={145}
                    rating={5}
            ...
            <div className="home__row">
                <Product
                    id="125"
                    title="Preethi MG214 Blue Leaf Expert Mixer Grinder, 750W, 3 jars with Master Chef Jar"
                    price={195}
                    rating={3}
                    image="https://images-na.ssl-images-amazon.com/images/I/4174-eEFjSL.jpg" />
                <Product
                    id="126"
                ...
                <Product
                    ...
                    price={790}
                    rating={5}
                    image="https://images-na.ssl-images-amazon.com/images/I/616bhfyXimL._SX679_.jpg" />
            </div>
            <div className="home__row">
                <Product
                    id="128"
                    title="OnePlus 138.8 cm (55 inches) Q1 Series 4K Certified Android QLED TV 55Q1IN-1 (Black) (Without Stand) powered by One plus made in China"
                    price={1350}
                    rating={4}
                    image="https://images-na.ssl-images-amazon.com/images/I/71EO3uGdJbL._SX679_.jpg" />
            </div>
        </div>
    )
}
