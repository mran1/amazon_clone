    ...
    return (
        <div className="login">
            ...
            <div className="login__container">
                ...
                <p>By signing in you agree amazon conditions of privacy and cookie management</p>
